...
class Agent:
    def __init__(self, agent_definition: dict, mcp_plugins: list[dict] = None):
        # Initialize the kernel
        self.kernel = Kernel()

        self.chat_completion = OllamaChatCompletion(
            ai_model_id=agent_definition.get("ai_model_id", "gpt-oss:20b"),
            host=agent_definition.get("host", "http://ollama.home"),
        )
